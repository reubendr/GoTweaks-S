...
{
    internal class LosslessScalingModeProperty : WidgetControlProperty<string, ComboBox>
    {
        public LosslessScalingModeProperty(ComboBox inUI, Page inOwner) : base("LS1", Function.LosslessScalingMode, inUI, inOwner)
        {
            if (UI != null)
            {
