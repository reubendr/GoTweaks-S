...
{
    internal class LosslessScalingFrameGenModeProperty : WidgetControlProperty<string, ComboBox>
    {
        public LosslessScalingFrameGenModeProperty(ComboBox inUI, Page inOwner) : base("x2", Function.LosslessScalingFrameGenMode, inUI, inOwner)
        {
            if (UI != null)
            {
