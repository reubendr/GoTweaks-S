...
public class IADLXGPU2 : IADLXGPU1 {
  ...
  public virtual ADLX_RESULT StartPowerOff(SWIGTYPE_p_adlx__IADLXGPUConnectChangedListener pGPUConnectChangedListener, int timeout) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXGPU2_StartPowerOff(swigCPtr, SWIGTYPE_p_adlx__IADLXGPUConnectChangedListener.getCPtr(pGPUConnectChangedListener), timeout);
    return ret;
  }
