...
Expanded Remapping: Full keyboard picker for remapping. Hold Legion L/R remapping. 
Hold L for temporary desktop controls. (Hold L for temporary desktop is **experimental**)
